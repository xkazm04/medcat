...
must_haves:
  truths:
    ...
    - "Multi-step tool execution allows search-then-compare workflows"
  artifacts:
...
- Return: { products, count } or { error, products: [] }

**suggestCategories tool:**
- InputSchema: query (string)
- Execute: call getProducts with query, pageSize 50
- Extract unique EMDN categories from results with counts
